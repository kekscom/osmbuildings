var Dome = {
  ...
  draw: function(context, center, radius, height, minHeight, color, altColor) {
    var
  ...
  shadow: function(context, center, radius, height, minHeight) {
    var
      a = { x:0, y:0 },
      b = { x:0, y:0 },
      c = { x:center.x-ORIGIN_X, y:center.y-ORIGIN_Y },
  ...
  hitArea: function(context, center, radius, height, minHeight, color) {
    var
      c = { x:center.x-ORIGIN_X, y:center.y-ORIGIN_Y },
      scale = CAM_Z / (CAM_Z-height),
      minScale = CAM_Z / (CAM_Z-minHeight),
